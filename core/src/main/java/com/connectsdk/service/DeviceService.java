...
/**
 * ###Overview
 * From a high-level perspective, DeviceService completely abstracts the functionality of a particular service/protocol (webOS TV, Netcast TV, Chromecast, Roku, DIAL, Matchstick, etc).
 *
 * ###In Depth
...
public class DeviceService implements DeviceServiceReachabilityListener, ServiceCommandProcessor {
    ...
    public static DeviceService getService(JSONObject json) {
        ...
        try {
            ...
            if (className.equalsIgnoreCase("Matchstick"))
                return null;
    ...
    /** Name of the DeviceService (webOS, Chromecast, Matchstick, etc) */
